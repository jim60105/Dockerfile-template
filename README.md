...
| [bmaltais/kohya_ss](https://github.com/bmaltais/kohya_ss)                                             | Python project containerization with ML dependencies (CUDA, torch, xformers, tensorflow). I helped this amazing open-source project set up the docker build CI.                                                                                                                                                                            | [🔗](https://github.com/bmaltais/kohya_ss/blob/master/Dockerfile)                              |
